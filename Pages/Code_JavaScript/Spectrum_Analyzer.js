...
function Analyze_Audio(){
  ...
  var Max = 100;
  var Step_Size = Max/7;
  var Bar_Count_1 = Math.round(Select_Frequencies[0]/Step_Size);
  var Bar_Count_2 = Math.round(Select_Frequencies[1]/Step_Size);
  var Bar_Count_3 = Math.round(Select_Frequencies[2]/Step_Size);
  var Bar_Count_4 = Math.round(Select_Frequencies[3]/Step_Size);
  var Bar_Count_5 = Math.round(Select_Frequencies[4]/Step_Size);
  var Bar_Count_6 = Math.round(Select_Frequencies[5]/Step_Size);
